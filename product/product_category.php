<?php 
    ...
    $p_category = explode("·", $product_category);
    $cnt = count($p_category);
?>
...
<html>
    <head>
        ...
        <style tyoe = "text/css">
            ...
            section p {float : left; margin-left : 120px; font-size : 18px; margin-top : 30px;}
    ...
    <body>
        ...
        <section>
            <p style = "margin-left : 0px; font-size : 20px; margin-top : 0px;"><?php echo $product_category."의 상품입니다."; ?></p>
            ...
            for($i = 0; $i<$cnt; $i++) {
                $sql = "select * from product_info where category = '".$p_category[$i]."';";
                    ...
                    <tr>
                        <td style = "width : 200px; height : 150px;">
                            <button type = "submit" value = <?php echo substr($img_src, 3); ?> name = "product" style = "width : 1150px;">
                                ...
                                <p style = "width : 350px; font-size : 24px;"><?php echo $name; ?></p>
                                <p style = "width : 100px;"><?php echo $price; ?></p>
                                <p style = "width : 80px;"><?php echo $category; ?></p>
                            </button>
                        </td>
                    </tr>
                </form>
